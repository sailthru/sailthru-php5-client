...
class Sailthru_Client {
	 ...
	 * @link http://docs.sailthru.com/api/blast
	 */
	public function updateBlast($blast_id, $name = null, $list = null, $schedule_time = null, $from_name = null, $from_email = null, $subject = null, $content_html = null, $content_text = null, $options = array()) {
		$data = $options;
	...
	/**
	 * Fetch name of template from revision
	 *
	 * @link http://docs.sailthru.com/api/template
	 */
	 ...
	 * Download a list.
	 *
	 * Obviously, this can potentially be a very large download.
	 * 'txt' is default format since, its more compact as compared to others
	 *
	 * @param String $list
	 * @param String $format
	 * @return txt | json | xml
	...
	/**
	 * Fetch email contacts from a user's address book on one of the major email websites.
	 *
	 * Currently supports AOL, Gmail, Hotmail, and Yahoo! Mail.
	 *
	 * @param String $email
	 ...
	 *
	 * You can add either a realtime or a summary alert (daily/weekly).
